...
const ROW_DEFS: RowDef[] = [
  ...
  {
    section: "Overview", label: "Market Cap", direction: "higher", rawKey: "marketCapRaw",
    render: (c) => c.marketCap || <span style={{ color: `rgb(var(--t-dim))` }}>—</span>,
  },
  // Financial Health
  {
    section: "Financial Health", label: "Revenue", direction: "higher", rawKey: "revenueRaw",
    render: (c) => c.revenue || <span style={{ color: `rgb(var(--t-dim))` }}>—</span>,
  },
  {
    section: "Financial Health", label: "Net Income", direction: "higher", rawKey: "netIncomeRaw",
    render: (c) => c.netIncome || <span style={{ color: `rgb(var(--t-dim))` }}>—</span>,
  },
  {
    section: "Financial Health", label: "Total Debt", direction: "lower", rawKey: "debtRaw",
    render: (c) => c.debt || <span style={{ color: `rgb(var(--t-dim))` }}>—</span>,
  },
  {
    section: "Financial Health", label: "Operating Cash Flow", direction: "higher", rawKey: "operatingCashFlowRaw",
    render: (c) => c.operatingCashFlow || <span style={{ color: `rgb(var(--t-dim))` }}>—</span>,
  },
  // Earnings
  {
    section: "Earnings", label: "Last EPS (actual)", direction: "higher",
    rawKey: undefined,
